  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(600px circle at ${pos.x}px ${pos.y}px, rgba(99,102,241,0.15), transparent 40%)`,
        }}
      />
...
export default function ServicesSection() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-20" id="services">
      ...
      {/* BENTO GRID */}
      <div className="mt-12 grid grid-cols-1 auto-rows-[14rem] gap-5 md:grid-cols-12">
        {/* Hero Tile */}
      <BentoCard className="relative overflow-hidden md:col-span-7 md:row-span-2">
        {/* ambient background */}
        <div className="pointer-events-none absolute inset-0 [background:radial-gradient(rgba(0,0,0,0.06)_1px,transparent_1px)] [background-size:18px_18px] dark:[background:radial-gradient(rgba(255,255,255,0.06)_1px,transparent_1px)]" />
        <div className="pointer-events-none absolute -top-24 -left-24 h-72 w-72 rounded-full bg-violet-400/25 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-fuchsia-400/25 blur-3xl" />

        <div className="relative z-10 grid h-full gap-6 p-4 md:grid-cols-2 md:p-6">
          {/* LEFT: copy + micro-interactions */}
          <div className="flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-500/15 to-fuchsia-500/15 px-3 py-1 text-xs font-medium text-violet-700 dark:text-violet-200">
              ...
              <p className="mt-2 max-w-lg text-sm text-gray-600 dark:text-gray-300">
                One team for product, engineering, and release. Review working builds weekly — not decks.
              </p>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {["React", "Expo", "TypeScript", "Tailwind", "CI/CD"].map((t) => (
                  <span
                    key={t}
          ...
          <div className="relative">
            ...
            {/* floating badges */}
            <div className="pointer-events-none absolute -bottom-3 -right-2 flex gap-2">
              <Badge>Expo</Badge>
              <Badge>React</Badge>
              <Badge>AWS</Badge>
            </div>
        ...
        <BentoCard className="md:col-span-5">
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 text-white shadow ring-1 ring-white/30">
        ...
        <BentoCard className="md:col-span-5">
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-sky-500 to-cyan-400 text-white shadow ring-1 ring-white/30">
            ...
            <div className="mt-auto flex gap-2">{["Expo", "OTA", "Stores"].map(chip)}</div>
          </div>
        </BentoCard>
        ...
        <BentoCard className="md:col-span-4">
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-emerald-500 to-lime-400 text-white shadow ring-1 ring-white/30">
            ...
            <div className="mt-auto flex gap-2">{["SLA", "Analytics", "QA"].map(chip)}</div>
          </div>
        </BentoCard>
        ...
        <BentoCard className="md:col-span-4">
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 text-white shadow ring-1 ring-white/30">
        ...
        <BentoCard className="md:col-span-4">
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 text-white shadow ring-1 ring-white/30">
            ...
            <div className="mt-auto flex gap-2">{["UX polish", "Perf", "A11y"].map(chip)}</div>
          </div>
        </BentoCard>
      </div>
    </section>
