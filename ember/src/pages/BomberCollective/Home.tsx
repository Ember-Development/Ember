    ...
    features: [
      {
        ...
        highlight: "Connect Bomber athletes with brands and manage partnerships.",
        description:
...
function VideoEmbed({
  ...
  const isYouTube =
    /youtube\.com|youtu\.be/.test(src) && src.includes("embed");
  const isVimeo = /vimeo\.com/.test(src) && src.includes("player.vimeo.com");
  const isMp4 = /\.mp4($|\?)/.test(src);

  if (isYouTube || isVimeo) {
    return (
      <div className={`relative aspect-video overflow-hidden ${rounded} border border-black/10 bg-black`}>
        <iframe
      ...
      <div className="absolute inset-0 grid place-items-center text-white/80">
        <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs backdrop-blur-md">
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" className="opacity-80">
            <path d="M7 7h10v10M7 17l10-10" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
          </svg>
        </div>
      </div>
    </a>
  ...
  return (
      ...
      <section className="relative overflow-hidden px-4 pt-20 pb-16 sm:px-6 lg:px-8 lg:pt-16">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 lg:flex-row lg:items-center">
          <Reveal>
            <div className="space-y-8 max-w-xl">
              <div className="inline-flex items-center gap-3 rounded-full border border-black/5 bg-white/70 px-4 py-1 shadow-sm backdrop-blur-sm">
                ...
                <span className="text-xs font-medium tracking-[0.16em] uppercase text-neutral-600">
                  Bomber Collective
                </span>
              </div>
              ...
              <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
                Bomber Collective is the parent company behind solutions that help
                empower Bomber Fastpitch athletes — NIL deal management, college
                recruiting tools, and custom web services through our partner Ember.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 text-sm font-medium text-neutral-900 hover:text-[var(--color-primary)] transition-all"
                >
                  Talk with our team
                  <svg
                    className="h-4 w-4"
          ...
          <Reveal>
            <div className="w-full lg:w-auto">
              <div className="relative mx-auto max-w-lg rounded-3xl border border-black/[0.06] bg-white/80 px-6 py-6 shadow-[0_18px_60px_rgba(15,15,15,0.07)] backdrop-blur-md">
                ...
                <div className="mt-5 grid grid-cols-3 gap-3 text-[9px] text-neutral-700">
                  <div className="rounded-2xl border border-black/5 bg-neutral-50 px-3 py-2">
                    ...
                    <div className="mt-0.5 font-semibold text-[0.75rem]">
                      For Bomber players
                    </div>
                  </div>
                  <div className="rounded-2xl border border-black/5 bg-neutral-50 px-3 py-2">
        ...
        <div className="mt-14">
          <div className="mx-auto max-w-6xl">
            <p className="mb-5 text-[10px] font-medium uppercase tracking-[0.18em] text-neutral-500 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-5 opacity-80">
              {[
                ...
                <div
                  key={partner.name}
                  className="transition-all duration-200 hover:opacity-100 hover:scale-[1.02]"
                >
                  <img
                    src={partner.logo}
                    alt={partner.name}
                    className="h-9 w-auto object-contain grayscale hover:grayscale-0 transition"
                  />
                </div>
              ))}
            </div>
    ...
    <Reveal>
      <div className="grid gap-10 lg:grid-cols-2">
        {/* Left: Copy + Stats */}
        <div className="rounded-3xl border border-black/[0.06] bg-white/80 p-8 sm:p-10 shadow-[0_18px_60px_rgba(15,15,15,0.05)] backdrop-blur-md">
          <div className="mb-5 h-0.5 w-12 rounded-full bg-[var(--color-primary)]" />
          <h2 className="mb-4 text-3xl sm:text-4xl font-semibold tracking-tight text-neutral-900">
            About <span className="bg-gradient-to-r from-[#D4AF37] to-black bg-clip-text text-transparent">Bomber Collective</span>
              </h2>
          <p className="text-neutral-600 leading-relaxed">
            Bomber Collective is the parent company behind platforms designed to
            empower Bomber Fastpitch athletes and partner organizations. We provide
            NIL deal management for Bomber players, recruiting tools to help them
            get discovered, and custom web services through our partnership with Ember.
          </p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              >
                <div className="text-xs uppercase tracking-[0.14em] text-[var(--color-primary)] mb-1">
                  {item.title}
                </div>
          ...
          <div className="mt-8 rounded-2xl border border-amber-500/20 bg-amber-50/40 p-4 text-sm text-neutral-700">
            "Empowering Bomber Fastpitch athletes with the tools they need to succeed
            — from NIL deals to college recruiting to world-class digital platforms."
          </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-black/[0.06] bg-white/80 p-6 shadow-[0_18px_60px_rgba(15,15,15,0.05)] backdrop-blur">
            <div className="mb-2 text-[10px] font-medium uppercase tracking-[0.16em] text-neutral-500">
              What the video covers
                  </div>
            <ul className="space-y-2 text-sm text-neutral-700">
              <li className="flex items-start gap-2">
                <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[var(--color-primary)]" />
                NIL platform for Bomber Fastpitch players to find and manage deals
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[var(--color-primary)]" />
                Recruiting tools to help Bomber athletes get discovered by colleges
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 h-1.5 w-1.5 rounded-full bg-[var(--color-primary)]" />
                Custom web services built by our partner Ember for Bombers and beyond
              </li>
            </ul>
      ...
      <section
        id="suite"
        className="px-4 pb-20 pt-10 sm:px-6 lg:px-8 bg-neutral-50"
      >
        <div className="mx-auto max-w-6xl flex flex-col gap-10 lg:flex-row">
          ...
          <div className="flex-1">
              ...
              {SUITE_CATEGORIES.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`relative pb-1 outline-none transition-all ${
                      isActive
                        ? "text-neutral-900"
                  ...
                  >
                    {category.name}
                    {isActive && (
                      <span className="absolute left-0 right-0 -bottom-1 h-[2px] rounded-full bg-[var(--color-primary)]" />
                    )}
                  </button>
                );
              })}
            ...
            <p className="mb-6 text-sm text-neutral-600 max-w-xl">
                ...
                return (
                  <button
                    ...
                    className={`group flex flex-col items-start rounded-2xl px-3 py-3 text-left transition-all outline-none ${
                      isSelected
                        ? "bg-neutral-900 text-white shadow-[0_12px_30px_rgba(15,15,15,0.3)] border border-[var(--color-primary)]"
                        : "bg-white text-neutral-900 border border-black/6 hover:border-[var(--color-primary)]/50 hover:shadow-md"
                    }`}
                  >
                    <div className="mb-0.5 text-[9px] uppercase tracking-[0.16em] text-[var(--color-primary)]">
                      {feature.tagline}
                    </div>
          ...
          <div className="flex-1">
            <Reveal>
              <div className="relative rounded-2xl bg-neutral-900 shadow-[0_16px_50px_rgba(15,15,15,0.1)] border border-black/[0.08] overflow-hidden aspect-video">
                ...
                <div className="absolute inset-x-0 bottom-0 px-4 py-4 sm:px-5 sm:py-5">
                  <div className="text-[9px] uppercase tracking-[0.16em] text-[var(--color-primary)] mb-1">
                    {activeCategory.name} Solutions
                  </div>
                  <h3 className="text-base sm:text-lg font-semibold text-white mb-2">
                    {currentFeature.label}
                  </h3>
                  <p className="text-[11px] sm:text-xs text-neutral-200 mb-2.5 leading-relaxed">
                  ...
                  <ul className="space-y-1 mb-2.5">
                    {currentFeature.bullets.map((b) => (
                      <li
                        key={b}
                        className="flex items-start gap-2 text-[10px] sm:text-[11px] text-neutral-300"
                      >
      ...
      <section
        id="contact"
        className="px-4 pb-20 sm:px-6 lg:px-8 bg-neutral-50"
      >
        <div className="mx-auto max-w-4xl">
          <Reveal>
            <div className="rounded-3xl border border-black/[0.04] bg-white p-8 shadow-[0_18px_50px_rgba(15,15,15,0.04)] backdrop-blur-md">
              <div className="flex flex-col gap-3 mb-6 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs sm:text-sm text-neutral-600 max-w-md">
                    Interested in NIL support, recruiting tools, or custom web services?
              ...
              >
                <div>
                  <label className="mb-1 block text-[10px] font-medium uppercase tracking-[0.16em] text-neutral-500">
                    Name
                  </label>
                  <input
                    required
                    name="name"
                    className="w-full rounded-2xl border border-black/10 bg-white px-3 py-2 text-sm text-neutral-900 outline-none transition-all focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)]"
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={4}
                    className="w-full rounded-2xl border border-black/10 bg-white px-3 py-2 text-sm text-neutral-900 outline-none transition-all resize-none focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)]"
